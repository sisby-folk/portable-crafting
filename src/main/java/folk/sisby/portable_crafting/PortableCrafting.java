...
public class PortableCrafting implements ModInitializer {
	...
	public void onInitialize() {
		...
		registerCraftingScreen(true, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "crafting_tables")), CraftingScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new CraftingScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.crafting")));
		registerCraftingScreen(true, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "smithing_tables")), SmithingScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new SmithingScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.upgrade")));
		registerCraftingScreen(true, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "grindstones")), GrindstoneScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new GrindstoneScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.grindstone_title")));
		registerCraftingScreen(true, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "cartography_tables")), CartographyTableScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new CartographyTableScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.cartography_table")));
		registerCraftingScreen(true, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "looms")), LoomScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new LoomScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.loom")));
		registerCraftingScreen(true, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "stonecutters")), StonecutterScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new StonecutterScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.stonecutter")));
		registerCraftingScreen(false, TagKey.of(RegistryKeys.ITEM, new Identifier("c", "anvils")), AnvilScreenHandler.class, new SimpleNamedScreenHandlerFactory((i, inv, p) -> new AnvilScreenHandler(i, inv, ScreenHandlerContext.create(p.getWorld(), p.getBlockPos())), Text.translatable("container.repair")));
